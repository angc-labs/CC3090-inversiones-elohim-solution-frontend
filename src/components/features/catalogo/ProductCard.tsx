        ...
        <div className="relative! mt-5! mx-2! rounded-2xl! p-5! flex! flex-col! gap-2!">
          ...
          <div className="grid! gap-3! sm:grid-cols-2!">
            <button
              ...
              disabled={isAdding}
              className="w-full! py-3! bg-gradient-to-r! from-blue-900! to-blue-800! text-white! rounded-full! font-semibold! text-sm! hover:shadow-md! flex! items-center! justify-center! gap-2! hover:from-blue-800! hover:to-blue-700! disabled:cursor-not-allowed! disabled:opacity-70!"
            >
